    ...
    <x-slot name="header">
        ...
        <form class="form-inline" action="/create" method="POST">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="StdPassword" class="block mt-1 w-full" type="password"  required autocomplete="new-password" />
            </div>

            <div class="mt-4">
                <x-jet-label for="phone" value="{{ __('Phone Number') }}" />
                <x-jet-input id="StdPhone" class="block mt-1 w-full" type="integer"  required autocomplete="phone" />
            </div>

            <div class="mt-4">
                <x-jet-label for="class" value="{{ __('Class') }}" />
                <x-jet-input id="StdClass" class="block mt-1 w-full" type="text"  required autocomplete="class" />
            </div>
